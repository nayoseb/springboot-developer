...
public class WebOAuthSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        //토큰 재발급은 URL은 인증 없이 접근 가능하도록 설정. 나머지 API URL은 인증 필요
        ...
        http.oauth2Login()
                ...
                //Authorizaiotn 요청과 관련된 상태 저장
                .authorizationRequestRepository(oAuth2AuthorizationRequestBasedOnCookieRepository()) //인증 성공 시 실행할 핸들러
                .and()
                .successHandler(oAuth2SuccessHandler()) //인증 실패 시 실행할 핸들ㄹ러
                .userInfoEndpoint()
        ...
        // /apu로 시작하는 url인 경우 401 상태 코드를 반환하도록 예외 처리
